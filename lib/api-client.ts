...
const mockSchemes: Scheme[] = [
  {
    ...
    gender: 'ALL',
    status: 'Active',
    beneficiaries: 'Any Indian citizen wanting to start or expand a non-farm income-generating activity (individuals, proprietary firms, partnership firms, etc.)',
    budget: 2000000,
    description: 'Seeks to promote entrepreneurship and financial inclusion among small business owners and individuals who may not have access to traditional banking services. Offers collateral-free loans up to ₹20 lakh to micro and small enterprises for income-generating activities in manufacturing, trading, and services.',
  ...
  },
  {
    ...
    budget: 100000,
    description: 'Provide farmers with timely and adequate credit to meet their short-term and long-term agricultural needs. Delivers short-term credit support for agricultural and allied activities, such as animal husbandry and fisheries.',
    created_at: todayIso,
    updated_at: todayIso,
  },
  {
    ...
    gender: 'ALL',
    status: 'Active',
    beneficiaries: 'Street vendors engaged in vending on or before March 24, 2020.',
    budget: 10000,
    description: 'Empowers street vendors with working capital loans and promotes digital transactions. Collateral-free working capital loans up to ₹10,000, a low-interest rate of 7%, and incentives for digital transactions.',
    official_site: 'https://pmsvanidhi.mohua.gov.in/',
    created_at: todayIso,
    updated_at: todayIso,
  },
  {
    ...
    gender: 'ALL',
    status: 'Active',
    beneficiaries: 'Traditional artisans and craftspeople practising 18 specified trades.',
    budget: 200000,
    description: 'To support traditional artisans with toolkit incentives, skill development, and collateral-free credit. Offers basic skill training (5-7 days) with a stipend of ₹500 per day, a Toolkit incentive of ₹15,000, and a collateral-free loan up to ₹2 lakh at a concessional interest rate.',
    official_site: 'https://pmvishwakarma.gov.in/',
    created_at: todayIso,
    updated_at: todayIso,
  },
  {
    id: 'S005',
    name: 'Pradhan Mantri Vidyalakshmi',
    category: 'EDUCATION',
    min_age: 1,
    max_age: 120,
    gender: 'ALL',
    status: 'Active',
    beneficiaries: 'Indian students seeking financial assistance for higher education.',
    budget: 2000000,
    description: 'A unified platform for students to apply for education loans from multiple banks. Beneficiaries generally receive up to ₹7.5 lakh (in India) and ₹20 lakh (abroad), as per bank norms.',
    official_site: 'https://pmvidyalaxmi.co.in/',
    created_at: todayIso,
    updated_at: todayIso,
  },
  {
  ...
  {
    id: 'S007',
    name: 'Sukanya Samruddhi Yojana (SSY)',
    category: 'SOCIAL_WELFARE',
    min_age: 1,
    max_age: 10,
    gender: 'FEMALE',
    status: 'Active',
    beneficiaries: 'Girl child up to age 10; one account per child (maximum two accounts for two daughters).',
    budget: 150000,
    description: 'Long-term savings scheme for girl child with tax benefits under Section 80C. Investment advantages include high return interest rates, tax benefits, and flexible deposit options.',
    created_at: todayIso,
    updated_at: todayIso,
  },
  {
    ...
    gender: 'ALL',
    status: 'Active',
    beneficiaries: 'Citizens between the ages of 18 and 40 who have a bank account.',
    budget: 5000,
    description: 'To provide a fixed monthly pension to subscribers after they reach the age of 60. A fixed monthly pension ranging from ₹1,000 to ₹5,000 after the age of 60.',
    official_site: 'https://enps.nsdl.com/eNPS/NationalPensionSystem.html',
    created_at: todayIso,
    updated_at: todayIso,
  },
];
...
const mockApplications: Application[] = Array.from({ length: 24 }).map((_, i) => ({
  ...
  income_range: '0-2L',
  benefited_scheme: i % 2 === 0 ? 'Pradhan Mantri Mudra Yojana' : 'Kisan Credit Card',
  scheme_id: i % 8 === 0 ? 'S001' : i % 8 === 1 ? 'S002' : i % 8 === 2 ? 'S003' : i % 8 === 3 ? 'S004' : i % 8 === 4 ? 'S005' : i % 8 === 5 ? 'S006' : i % 8 === 6 ? 'S007' : 'S008',
